...
namespace OrderingService.Application.CommandHandlers
{
        ...
        : IRequestHandler<CreateOrderCommand, bool>
    {
        ...
        public CreateOrderCommandHandler(IOrderRepository orderRepository, ILoggerFactory loggerFactory)
        {
            _orderRepository = orderRepository ?? throw new ArgumentNullException(nameof(orderRepository));
            _logger = loggerFactory.CreateLogger(nameof(CreateOrderCommandHandler));
        }
        ...
        public async Task<bool> Handle(CreateOrderCommand message, CancellationToken cancellationToken)
        {
            ...
            return await Task.FromResult(_orderRepository.UnitOfWork.SaveEntities());
        }
    }
}
